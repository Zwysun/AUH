...
def capframe(stack1, stack2, top):
...
def detectyellowball(stack, flag):
...
if __name__ == '__main__':
    ...
    q2 = Manager().list()
    flag=Value("d",int(0))
    pw = Process(target=capframe, args=(q1, q2, int(100)))
    pw2 = Process(target=detectyellowball, args=(q1, flag, ))
