...
#define Kp_pitch       0//比例常数(0.32)
#define Ti_pitch      0.2  //积分时间常数
#define Td_pitch      0.0025//0.0028   微分时间常数
...
#define P_pitch				0.6//0.3   Kp_pitch+Ki_pitch+Kd_pitch
#define I_pitch				0.04//0.02 Kp_pitch+2*Kd_pitch
#define D_pitch				0.1// 0    Kd_pitch  PITCH的D我觉得要很大……因为PITCH歪掉后会很容易导致斜向喷射

#define Kp_depth       3.3
#define Ti_depth      20  //积分时间常数
#define Td_depth      0.0025//0.0028   微分时间常数
#define Ts_depth       0.25 //采样周期0.1ms，想和速度读取的时间同步
